...
public final class ActivityLogoutBinding implements ViewBinding {
  ...
  private ActivityLogoutBinding(@NonNull ConstraintLayout rootView, @NonNull Button logout) {
  ...
  public static ActivityLogoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLogoutBinding((ConstraintLayout) rootView, logout);
    }
